                ...
                <div className='flex flex-col md:flex-row justify-center items-center space-x-10'>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='w-60 md:w-auto mx-auto mt-5 md:mt-0'>
                            <button onClick={() => {handleSetData(appDatas), handleChackLoleData()}} className={`btn w-65 p-6 border-0 ${appIntalled ? 'bg-green-600 disabled:cursor-not-allowed' : 'bg-[#00D390]'} font-semibold text-white text-[17px] mt-3`}>{appIntalled ? 'Installed' : `Installed Now (${size} MB)`}</button>
                        </div>
                    </div>
                </div>
            </div>
